    ...
    <div id="contact" className="min-h-screen p-4 flex justify-center items-center">
      <div className="max-w-5xl">
        ...
        <div className="flex flex-wrap gap-8 justify-center">
          <div className="border-2 bg-blue border-black rounded-lg">
          ...
          <div className="border-2 bg-purple border-black rounded-lg">
            <a href="mailto:yashsawantw@gmail.com" target="_blank" className="p-4 flex justify-center items-center hover:bg-hover-shadow transition-all">
              <img src={mail} alt="Instagra Profile" className="size-16" />
            </a>
          </div>
